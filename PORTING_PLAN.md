...
## Stage 2 — Data model migration *(completed)*
...
- Add unit tests (QTest or Qt based) that cover grid loading, session lifecycle and persistence routines.

## Stage 3 — Main window & project management *(completed)*
...
## Stage 4 — Graph visualisation workspaces *(completed)*
...
## Stage 5 — Specialised dialogs and tools *(in progress)*
